...
<%@ page import="com.arkap.service.impl.*, com.arkap.service.*"%>
...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		...
		<h2>Electronical</h2>
		<h6>We specialize in Smart Electronics</h6>
	...
	int notf = new CartServiceIMPLEMENT().getCartCount((String) session.getAttribute("username"));
	%>
	<nav class="navbar navbar-default navbar-fixed-top">
