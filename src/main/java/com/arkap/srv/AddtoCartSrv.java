...
import com.arkap.service.impl.CartServiceIMPLEMENT;
import com.arkap.service.impl.DemandServiceIMPLEMENT;
import com.arkap.service.impl.ProductServiceIMPLEMENT;
...
public class AddtoCartSrv extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		CartServiceIMPLEMENT cart = new CartServiceIMPLEMENT();

		ProductServiceIMPLEMENT productDao = new ProductServiceIMPLEMENT();
		...
		if (pQty == cartQty) {
			...
			DemandServiceIMPLEMENT demand = new DemandServiceIMPLEMENT();
