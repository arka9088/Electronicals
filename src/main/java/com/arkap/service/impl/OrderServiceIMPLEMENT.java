package com.arkap.service.impl;
...
import com.arkap.beans.CartBean;
import com.arkap.beans.OrderBean;
import com.arkap.beans.OrderDetails;
import com.arkap.beans.TransactionBean;
import com.arkap.service.OrderService;
import com.arkap.utility.DBUtil;
import com.arkap.utility.MailMessage;
...
public class OrderServiceIMPLEMENT implements OrderService {
	...
	public String paymentSuccess(String userName, double paidAmount) {
		...
		cartItems = new CartServiceIMPLEMENT().getAllCartItems(userName);
		...
		for (CartBean item : cartItems) {
			...
			double amount = new ProductServiceIMPLEMENT().getProductPrice(item.getProdId()) * item.getQuantity();
			...
			if (!ordered)
				...
				ordered = new CartServiceIMPLEMENT().removeAProduct(item.getUserId(), item.getProdId());
			}

			if (!ordered)
				break;
			else
				ordered = new ProductServiceIMPLEMENT().sellNProduct(item.getProdId(), item.getQuantity());
		...
		if (ordered) {
			ordered = new OrderServiceIMPLEMENT().addTransaction(transaction);
			if (ordered) {
