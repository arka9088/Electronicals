...
import com.arkap.beans.DemandBean;
import com.arkap.beans.ProductBean;
import com.arkap.service.ProductService;
import com.arkap.utility.DBUtil;
import com.arkap.utility.IDUtil;
...
public class ProductServiceIMPLEMENT implements ProductService {
	...
	public String updateProductWithoutImage(String prevProductId, ProductBean updatedProduct) {
		...
		int prevQuantity = new ProductServiceIMPLEMENT().getProductQuantity(prevProductId);
		Connection con = DBUtil.provideConnection();
		...
		try {
			...
			if ((k > 0) && (prevQuantity < updatedProduct.getProdQuantity())) {
				...
				List<DemandBean> demandList = new DemandServiceIMPLEMENT().haveDemanded(prevProductId);
				...
				for (DemandBean demand : demandList) {
					...
					boolean flag = new DemandServiceIMPLEMENT().removeProduct(demand.getUserName(), prevProductId);
